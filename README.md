...
가장자리 테이퍼는 342장 grouped 5-fold와 외부 실사 10장 비교에서 유의미한 개선이 없어서 릴리스 추론 경로에서 제거했습니다. 전체 프레임에 같은 보정식을 적용합니다.
...
첫 Gemini 출력을 공유한 뒤 다음 두 체인을 비교했습니다.

1. `Gemini -> Gemini -> Gemini -> Gemini -> Gemini`
2. `Gemini -> correction -> Gemini -> correction -> ...` 5회
